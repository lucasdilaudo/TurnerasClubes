<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TurnosNuevoCurso.aspx.cs" Inherits="TPIntegrador_2020.TurnosNuevoCurso" %>
...
<div id="SubMenu">
   <table class="tablaSubMenu">
    ...
    <div id="Contenido">
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Inscribirse a Curso"></asp:Label>
        <br />
        &nbsp;<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TPIFinalClubDeportivoConnectionString %>" SelectCommand="SELECT codigo_curso, descripcion_curso FROM cursos WHERE (estado_curso = 1) ORDER BY descripcion_curso"></asp:SqlDataSource>
        <br />
        <table class="tablaContenido">
            <tr>
                <td>Curso</td>
                <td>
                    <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="descripcion_curso" DataValueField="codigo_curso" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Deporte</td>
                <td>
                    <asp:Label ID="lblDeporte" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Inscribirse" />
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
